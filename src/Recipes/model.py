...
class Receta(Base): 
    ...
    def __init__(self, nombre_receta: str, clasificacion: str, periodo: str, comensales_base: int, estatus:bool) -> None:
    ...
    def update(self, session, nombre_receta: str | None = None, clasificacion: str | None = None, periodo: str | None = None, comensales_base: int | None = None, estatus: bool | None = None) -> None:
        if nombre_receta:
            self.nombre_receta = nombre_receta
        if clasificacion:
            self.clasificacion = clasificacion
    ...
    def __repr__(self) -> str:
        return f"Receta: {self.nombre_receta}, {self.clasificacion}, {self.periodo}, {self.comensales_base}, {self.estatus} ,comensales"
